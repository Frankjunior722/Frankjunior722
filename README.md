...
<p align="left" style="display:flex; align-items:center; gap:8px;">
 ...
 <a href="https://x.com/emerie_frank" target="_blank" title="X Profile"> 
  ...
  <a href="https://www.linkedin.com/in/jr-vic/" target="_blank" title="LinkedIn Profile">
    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linkedin/linkedin-original.svg" alt="LinkedIn" width="28" height="28"/>
  </a>

  <a href="https://badges.pufler.dev" target="_blank" title="Profile Views">
    <img src="https://badges.pufler.dev/visits/Frankjunior722/Frankjunior722" alt="Profile Views"/>
  </a>

  <span style="margin-left:auto;">
    <img 
      src="https://img.shields.io/badge/gender-%F0%9F%A4%B5-lightgrey" 
      alt="Gender"
      title="Male"
    />
  </span>
...
### Skills 🛠️ and  Planned Projects  🐾

| Skills | Planned Project |
|---|---|
| SIEM Monitoring, Threat Detection, Log Analysis | SOC Analyst Labs |
| Threat Hunting, SPL Queries, Security Analytics | Splunk Detection Dashboards |
| Event Investigation, Log Correlation | Log Analysis Projects |
...
- **Distinction:** First Class Honours, Federal University of Technology, Owerri (2019 - 2024)
